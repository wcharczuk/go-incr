...
func FoldLeft[T, O any](ctx context.Context, i Incr[[]T], v0 O, fn func(O, T) O) Incr[O] {
	o := &foldLeftIncr[T, O]{
		n:   NewNode(),
		i:   i,
		fn:  fn,
...
// to the next interation, yielding a single value.
func FoldRight[T, O any](ctx context.Context, i Incr[[]T], v0 O, fn func(T, O) O) Incr[O] {
	o := &foldRightIncr[T, O]{
		n:   NewNode(),
		i:   i,
		fn:  fn,
