...
func DiffMapByKeys[K comparable, V any](i incr.Incr[map[K]V]) (add incr.Incr[map[K]V], rem incr.Incr[map[K]V]) {
...
func DiffMapByKeysAdded[K comparable, V any](i incr.Incr[map[K]V]) incr.Incr[map[K]V] {
...
func DiffMapByKeysRemoved[K comparable, V any](i incr.Incr[map[K]V]) incr.Incr[map[K]V] {
